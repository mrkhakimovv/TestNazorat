      ...
      <div className="grid gap-4">
        {results.map(r => (
          <div 
            ...
            className="bg-white border border-slate-200 p-4 sm:p-5 rounded-sm flex flex-col md:flex-row md:items-center justify-between gap-4 cursor-pointer hover:border-amber-400 hover:shadow-sm transition-all"
          >
            <div className="flex-1">
              <h4 className="font-bold text-[#1E293B] text-lg mb-2">{r.testTitle}</h4>
              <div className="flex flex-wrap items-center gap-3 text-sm text-slate-500">
                <span className="flex items-center gap-1 font-mono bg-slate-50 px-2 py-0.5 rounded-sm border border-slate-100"><FileText size={14} /> {r.testCode}</span>
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 md:justify-end shrink-0 pt-3 border-t border-slate-100 md:pt-0 md:border-t-0">
              ...
              <div className="pl-4 border-l border-slate-100 flex items-center justify-center text-slate-300">
